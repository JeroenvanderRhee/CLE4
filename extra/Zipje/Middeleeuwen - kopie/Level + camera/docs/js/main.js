...
var Game = (function () {
    ...
    Game.prototype.createbars = function () {
        this.Bar.push(new Ground(56, 1920, window.innerHeight, 0));
        this.Bar.push(new Ground(56, 920, window.innerHeight, 1980));
        this.Bar.push(new Ground(600, 100, window.innerHeight, 2800));
        this.Bar.push(new Ground(56, 920, 200, 1980));
        this.Bar.push(new Ground(56, 400, 350, 2800));
        this.Bar.push(new Ground(56, 700, window.innerHeight, 3000));
        this.Bar.push(new Ground(56, 530, window.innerHeight, 3770));
...
var Ground = (function () {
    function Ground(height, width, positiony, positionx) {
